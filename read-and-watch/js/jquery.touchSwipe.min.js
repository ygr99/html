    ...
    function y(m, g) {
        ...
        function U(e, f) {
            if (g.allowPageScroll === s) {
                ...
                switch (f) {
                    case t:
                        if (g.swipeLeft && l || !l && g.allowPageScroll != u) {
                            if (e.preventDefault) {
                                e.preventDefault()
                            } else {
                                e.returnValue = false
                        ...
                        break;
                    case n:
                        if (g.swipeRight && l || !l && g.allowPageScroll != u) {
                            if (e.preventDefault) {
                                e.preventDefault()
                            } else {
                                e.returnValue = false
                        ...
                        break;
                    case r:
                        if (g.swipeUp && l || !l && g.allowPageScroll != a) {
                            if (e.preventDefault) {
                                e.preventDefault()
                            } else {
                                e.returnValue = false
                        ...
                        break;
                    case i:
                        if (g.swipeDown && l || !l && g.allowPageScroll != a) {
                            if (e.preventDefault) {
                                e.preventDefault()
                            } else {
                                e.returnValue = false
        ...
        var y = d || !g.fallbackToMouseEvents,
            b = y ? "touchstart" : "mousedown",
            w = y ? "touchmove" : "mousemove",
            E = y ? "touchend" : "mouseup",
            S = "touchcancel";
        var x = 0;
        var T = null;
        var N = 0;
