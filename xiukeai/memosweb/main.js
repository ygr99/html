...
for(var i=0;i < data.length;i++){
    ...
    result += "<li class='bb-list-li'><div class='bb-div'><div class='datatime'>"+new Date(data[i].createdTs * 1000).toLocaleString('zh')+"</div><div class='datacont'>"+bbContREG+"</div></div></li>"
}// end for
